...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 427d079f-c97b-49ba-ba4e-307146bbe578
```

> `427d079f-c97b-49ba-ba4e-307146bbe578` is the password of the certificate, you can change it to any password you want.
